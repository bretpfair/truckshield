...
interface InviteReminderProps {
  ...
  portalLink?: string
  companyName?: string
  daysSinceInvite?: string
}

const InviteReminderEmail = ({ firstName, portalLink, companyName, daysSinceInvite }: InviteReminderProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Reminder: Your secure client portal is waiting — {SITE_NAME}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          If you have questions or need help getting started, reply to this email or call us at{' '}
...
export const template = {
  component: InviteReminderEmail,
  subject: 'Reminder: Your Client Portal is Waiting — 360 Risk Partners',
