...
const ApplicationReminderEmail = ({ firstName, companyName, completionPercent, portalLink }: ApplicationReminderProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your trucking insurance application for {companyName || 'your company'} is incomplete — finish it to get quoted</Preview>
    <Body style={main}>
